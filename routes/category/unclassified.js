...
router.get('/', authUtil.isLoggedin ,async (req, res) => {
    ...
    (SELECT C.category_idx, C.user_idx, C.contents_idx, C.title, C.thumbnail, C.contents_url, C.estimate_time, C.created_date, C.read_flag, C.delete_flag, COUNT(H.highlight_idx) AS highlight_cnt FROM contents C LEFT JOIN highlight H
